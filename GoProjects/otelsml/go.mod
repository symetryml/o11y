module github.com/symetryml/otelsml

go 1.26.1

require (
	github.com/symetryml/demclient v0.0.0
	github.com/symetryml/godf v0.0.0
	github.com/symetryml/oteletl v0.0.0
...
replace (
	github.com/symetryml/demclient => ../demclient
	github.com/symetryml/godf => ../godf
	github.com/symetryml/oteletl => ../oteletl
)
